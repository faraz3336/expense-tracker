...
function Register() {
  ...
  const onSubmit = async (data) => {
    setIsLoading(true);
    await AuthService.register_req(
      data.username,
      data.email,
      data.password,
    ).then(
  ...
  return (
    <div className="container">
      <form className="auth-form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="input-box">
          ...
          <input
            ...
            {...register("cpassword", {
              ...
              validate: {
                matchPassword: (cpass) =>
                  cpass === password.current || "Passwords do not match!",
                strongPassword: (cpass) =>
                  /^(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*])/.test(cpass) ||
        ...
        <br />
        <div className="msg">
          By clicking Register, you are agree to our user agreement, privacy
